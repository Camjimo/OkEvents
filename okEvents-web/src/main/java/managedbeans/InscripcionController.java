...
import sessionbeans.InscripcionFacadeLocal;
...
public class InscripcionController implements Serializable {
    ...
    @EJB
    private InscripcionFacadeLocal ejbFacade;
    ...
    private InscripcionFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public Inscripcion getInscripcion(java.lang.Long id) {
